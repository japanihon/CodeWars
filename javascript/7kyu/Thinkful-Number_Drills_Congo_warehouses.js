...
const boxCapacity = (length, width, height) => {
  const convertLenghByBox = parseInt(length * 12 / 16)
  const convertWidthByBox = parseInt(width * 12 / 16)
  const convertHeightByBox = parseInt(height * 12 / 16)
  return convertLenghByBox * convertWidthByBox * convertHeightByBox
}
